...
const socialLinks = [
  { icon: TwitterIcon, href: "https://x.com/provibeapp", label: "Twitter" },
  { icon: InstagramIcon, href: "https://instagram.com/provibeapp", label: "Instagram" },
  { icon: LinkedinIcon, href: "https://linkedin.com/company/provibe", label: "LinkedIn" },
]
